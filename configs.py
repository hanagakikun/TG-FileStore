...
class Config(object):
	API_ID = int(os.environ.get("13084577", "0"))
	API_HASH = os.environ.get("1c0b20897a5fd2a674db1fa45d4c1a96")
	BOT_TOKEN = os.environ.get("BOT_TOKEN")
	BOT_USERNAME = os.environ.get("Hanagaki_File_Stream_Bot")
	DB_CHANNEL = int(os.environ.get("-1002474217593", "-100"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1298304662"))
	DATABASE_URL = os.environ.get("mongodb+srv://sansumabaro046:15LxLs6Z2Ffm2xFk@cluster0.7pscq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002120845917")
	LOG_CHANNEL = os.environ.get("-1002474217593L")
